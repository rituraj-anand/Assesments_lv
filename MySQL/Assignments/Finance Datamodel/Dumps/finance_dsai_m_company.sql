...
DROP TABLE IF EXISTS `dsai_m_company`;
...
LOCK TABLES `dsai_m_company` WRITE;
/*!40000 ALTER TABLE `dsai_m_company` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsai_m_company` ENABLE KEYS */;
UNLOCK TABLES;
