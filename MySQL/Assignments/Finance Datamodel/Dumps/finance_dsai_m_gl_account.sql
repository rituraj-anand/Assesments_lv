...
DROP TABLE IF EXISTS `dsai_m_gl_account`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dsai_m_gl_account` (
  `GL_Account_Number` int DEFAULT NULL,
...
LOCK TABLES `dsai_m_gl_account` WRITE;
/*!40000 ALTER TABLE `dsai_m_gl_account` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsai_m_gl_account` ENABLE KEYS */;
UNLOCK TABLES;
