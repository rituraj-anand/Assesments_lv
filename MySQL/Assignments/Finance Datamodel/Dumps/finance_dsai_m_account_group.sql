...
DROP TABLE IF EXISTS `dsai_m_account_group`;
...
LOCK TABLES `dsai_m_account_group` WRITE;
/*!40000 ALTER TABLE `dsai_m_account_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsai_m_account_group` ENABLE KEYS */;
UNLOCK TABLES;
