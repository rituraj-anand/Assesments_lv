...
DROP TABLE IF EXISTS `dsai_m_exchange_rate`;
...
LOCK TABLES `dsai_m_exchange_rate` WRITE;
/*!40000 ALTER TABLE `dsai_m_exchange_rate` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsai_m_exchange_rate` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-04-04 22:38:06
