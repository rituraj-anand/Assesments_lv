...
DROP TABLE IF EXISTS `dsai_m_cost_center`;
...
LOCK TABLES `dsai_m_cost_center` WRITE;
/*!40000 ALTER TABLE `dsai_m_cost_center` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsai_m_cost_center` ENABLE KEYS */;
UNLOCK TABLES;
