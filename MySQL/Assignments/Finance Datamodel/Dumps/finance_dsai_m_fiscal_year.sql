...
DROP TABLE IF EXISTS `dsai_m_fiscal_year`;
...
LOCK TABLES `dsai_m_fiscal_year` WRITE;
/*!40000 ALTER TABLE `dsai_m_fiscal_year` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsai_m_fiscal_year` ENABLE KEYS */;
UNLOCK TABLES;
