...
DROP TABLE IF EXISTS `dsai_m_posting_period`;
...
LOCK TABLES `dsai_m_posting_period` WRITE;
/*!40000 ALTER TABLE `dsai_m_posting_period` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsai_m_posting_period` ENABLE KEYS */;
UNLOCK TABLES;
