...
DROP TABLE IF EXISTS `dsai_t_gl_posting`;
...
LOCK TABLES `dsai_t_gl_posting` WRITE;
/*!40000 ALTER TABLE `dsai_t_gl_posting` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsai_t_gl_posting` ENABLE KEYS */;
UNLOCK TABLES;
