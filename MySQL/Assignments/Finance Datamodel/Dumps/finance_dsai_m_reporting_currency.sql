...
DROP TABLE IF EXISTS `dsai_m_reporting_currency`;
...
LOCK TABLES `dsai_m_reporting_currency` WRITE;
/*!40000 ALTER TABLE `dsai_m_reporting_currency` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsai_m_reporting_currency` ENABLE KEYS */;
UNLOCK TABLES;
