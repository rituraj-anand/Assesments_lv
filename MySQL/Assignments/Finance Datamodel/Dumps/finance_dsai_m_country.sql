...
DROP TABLE IF EXISTS `dsai_m_country`;
...
LOCK TABLES `dsai_m_country` WRITE;
/*!40000 ALTER TABLE `dsai_m_country` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsai_m_country` ENABLE KEYS */;
UNLOCK TABLES;
